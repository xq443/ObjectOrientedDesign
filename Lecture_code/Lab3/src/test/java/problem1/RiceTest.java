...
class RiceTest {
  ...
  void testEquals_DifferentDataTypes(){
    assertFalse(testRice.equals("I am a String"));
  }

  @Test
  void testEquals_DifferentName(){
    Rice otherRice = new Rice("Long grain rice", 3.45, 128);
  ...
  @Test
  void testHashCode() {
    int expectedHashCode = Objects.hash(testRice.getName(), testRice.getCurrPricePerUnit(),
        testRice.getCurrAvailableQuantity(), testRice.getMaxAllowedQuantity());
